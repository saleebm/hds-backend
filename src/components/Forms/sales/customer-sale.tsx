...
import { Box, Button, Grid, Theme, Typography, Paper } from '@material-ui/core'
 ...
 * @constructor
 */
export function CustomerSaleForm({ customerOrderState }: CustomerSale) {
...
export default connect(mapStateToProps)(CustomerSaleForm)
